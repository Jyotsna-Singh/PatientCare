...
class AppointmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'appontment_date' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'patient_id' => 1,
            'doctor_id' => 1,
            'appontment_date' => '2017-02-01 02:16:56',
            'created' => '2017-02-01 02:16:56',
            'modified' => '2017-02-01 02:16:56'
        ],
    ];
}
